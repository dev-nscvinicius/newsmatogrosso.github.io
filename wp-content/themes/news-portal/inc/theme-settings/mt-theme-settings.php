...
class News_Portal_Settings {
	...
	public function about_theme_styles( $hook ) {
		wp_enqueue_style( 'mt-theme-review-notice', get_template_directory_uri() . '/inc/theme-settings/assets/css/theme-review-notice.css', array(), NEWS_PORTAL_VERSION );
	...
	public function about_theme_scripts( $hook ) {
		...
		if ( $theme_notice_option ) {
			wp_enqueue_script( 'mt-theme-review-notice', get_template_directory_uri() . '/inc/theme-settings/assets/js/theme-review-notice.js', array( 'jquery' ), NEWS_PORTAL_VERSION );
		...
		wp_enqueue_script( 'mt-theme-settings-script', get_template_directory_uri() . '/inc/theme-settings/assets/js/settings.js', array( 'jquery' ), NEWS_PORTAL_VERSION );
